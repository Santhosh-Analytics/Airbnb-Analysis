...
with st.sidebar:
    ...
    selected = option_menu(
        "Main Menu",
        ["Home", "Data Exploration", "EDA"],
        icons=["house-door-fill", "bar-chart-fill", "credit-card"],
        menu_icon="cast",
        default_index=0,
        styles={
...
st.markdown(
    """ <style> button[data-baseweb="tab"] > di v[data-testid="stMarkdownContainer"] > p {font-size: 28px;} </style>""",
    unsafe_allow_html=True,
)


st.markdown(
    "<h1 style='text-align: center; font-size: 38px; color: #FF385C ; font-weight: 700;font-family:sans serif;'>Airbnb Listings Data Analysis</h1>",
    unsafe_allow_html=True,
)
...
if selected == "Home":
    ...
    st.image(image, width=True, caption=about)
    add_vertical_space(1)

    st.markdown(
        "<h3 style='font-size: 30px;text-align:left; font-family:sans serif;color: #FF385C;'> What is Airbnb?  </h3>",
        unsafe_allow_html=True,
    )

    st.markdown(
        """<p  style='text-align: left; font-size: 18px; color: #ffffff; font-weight: 400;font-family:sans serif;'>  
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;      
    ...
    st.markdown(
        "<h3 style='font-size: 30px;text-align:left; font-family:sans serif;color: #FF385C;'> About Airbnb:  </h3>",
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        f"""<p  style='text-align: left; font-size: 18px; color: #ffffff; font-weight: 400;font-family:sans serif;'>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    {about} </p>""",
        unsafe_allow_html=True,
    )
    ...
    **kwargs,
    ...
    if chart_type == "lne":
        ...
        if "text_auto" in kwargs:
            ...
            fig = px.bar(
                data, x=_x_column, y=y_column, text=y_column, **kwargs
            ).update_layout(width=widthv, height=heightv)
        else:
            fig = px.bar(data, x=_x_column, y=y_column, **kwargs).update_layout(
...
country = st.sidebar.selectbox(
    "Select the Country", ["All"] + list(map(str, df["country"].unique()))
)
...
if selected == "Data Exploration":
    st.markdown(
        "<style>div.css-1jpvgo6 {font-size: 16px; font-weight: bolder;font-family:sans serif; } </style>",
        unsafe_allow_html=True,
    )
    ...
    with tab:
        ...
        property_counts = pd.DataFrame(
            df0.groupby(["property_type"]).agg({"_id": "count", "price": "mean"})
        ).reset_index()
        room_counts = pd.DataFrame(
            df0.groupby(["room_type"]).agg({"_id": "count", "price": "mean"})
        ).reset_index()
        ...
        colpie, space, colcount = st.columns([1, 0.00001, 1])
        ...
        with colpie:
            st.plotly_chart(
                ...
                .update_traces(
                    ...
                    hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                    hovertemplate="<b>Property Type:</b> %{label}<br>"
        ...
        space.markdown(
            "<div style='border-left: 3px solid #FF385C;font-family:PhonePeSans; height: 400px;'></div>",
            unsafe_allow_html=True,
        )
        ...
        st.header(
            "**Listing count in terms of cancellation policy and comparing with Property & Room type:**"
        )

        cancel_room = (
            df0.groupby(["cancellation_policy", "property_type"])
            .size()
            .reset_index(name="count")
            .sort_values(by="count", ascending=False)
        )

        a, b, c = st.columns([1, 0.0001, 1])
        ...
        cancel_prpty = (
            df0.groupby(["cancellation_policy", "room_type"])
            .size()
            .reset_index(name="count")
            .sort_values(by="count", ascending=False)
        )
        ...
        st.plotly_chart(
            ...
            .update_layout(
                ...
                xaxis={"categoryorder": "total descending"},
                yaxis={"categoryorder": "total ascending"},
                legend_font=dict(size=13, color="azure"),
                legend=dict(bgcolor="rgba(0,0,0,0)"),
                legend_title_text="Room Type",
                legend_title_font=dict(size=14, color="azure"),
            ),
            use_container_width=True,
        )
        ...
        room_type_ctry = (
            df0.groupby(["region", "property_type"])
            .size()
            .reset_index(name="count")
            .sort_values(by="count", ascending=False)
        )
        ...
        b.markdown(
            "<div style='border-left: 3px solid #FF385C;font-family:PhonePeSans; height: 500px;'></div>",
            unsafe_allow_html=True,
        )

        a.header("**Listings Count by country and Property Type:**")
        room_type_ctry = (
            df0.groupby(["country", "property_type"])
            .size()
            .reset_index(name="count")
            .sort_values(by="count", ascending=False)
        )
        ...
        top_host = pd.DataFrame(
            df0.groupby(["host_id", "superhost"])
            .agg({"number_of_reviews": "count", "host_total_listings_count": "sum"})
            .reset_index()
        ).nlargest(15, "host_total_listings_count")
        ...
        st.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Host ID:</b> %{label}<br>"
                + "<b>Count:</b> %{y:,.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=True,
            ...
            .update_layout(
                ...
                height=450,
                xaxis={"categoryorder": "total descending"},
                yaxis={"title": "Price", "categoryorder": "total ascending"},
                legend_font=dict(size=13, color="white"),
                legend=dict(bgcolor="rgba(0,0,0,0)"),
                legend_title_text="Room Type",
                legend_title_font=dict(size=14, color="white"),
            ...
            .update_xaxes(title="Host_id", type="category"),
            use_container_width=True,
        )
    ...
    with tab1:
        ...
        country = col1.selectbox(
            "Select the Country",
            ["All"] + list(map(str, df["country"].unique())),
            key=1,
        )
        ...
        region = col2.selectbox(
            "Select the Region", ["All"] + list(map(str, reg)), key=2
        )
        ...
        price_prpty = (
            df0.groupby("property_type")["price"]
            .mean()
        ...
        c.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Room Type:</b> %{label}<br>"
                + "<b>Average Price:</b> %{y:.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=False,
        ...
        a, b, c = st.columns([0.6, 0.0001, 1])

        price_cancel = (
            df0.groupby("cancellation_policy")["price"]
            .mean()
            .reset_index(name="price")
            .sort_values(by="price", ascending=False)
        )
        ...
        a.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Policy Type:</b> %{label}<br>"
                + "<b>Average Price:</b> %{y:.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=False,
        ...
        price_accom = (
            df0.groupby("accommodates")["price"]
            .mean()
            .reset_index(name="price")
            .sort_values(by="price", ascending=False)
        )
        ...
        c.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Accommodates Count:</b> %{label}<br>"
                + "<b>Average Price:</b> %{y:.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=False,
            ...
            .update_xaxes(title="Accommodates", type="category"),
            use_container_width=True,
        )
        ...
        time = (
            df0.groupby(["room_type", "last_scraped"])["price"]
            .mean()
            .reset_index(name="price")
            .sort_values(by="last_scraped")
        )
        ...
        fig = (
            ...
            .update_traces(
                hovertemplate="<b>Last_Scraped:</b> %{x}<br>"
                + "<b>Average Price:</b> %{y:.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=True,
        ...
        time = (
            df0.groupby(["superhost", "last_scraped"])["price"]
            .mean()
            .reset_index(name="price")
            .sort_values(by="last_scraped")
        )
        ...
        a, b, c = st.columns([0.8, 0.0001, 1])

        price_cty = pd.DataFrame(
            df0.groupby("country")
            .agg({"number_of_reviews": "count", "price": "mean"})
            .reset_index()
        )
        ...
        a.plotly_chart(
            ...
            .update_xaxes(title="Country", type="category"),
            use_container_width=True,
        )
        ...
        c.plotly_chart(
            ...
            .update_xaxes(title="Region", type="category"),
            use_container_width=True,
        )
        ...
        a.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Minimum Nights:</b> %{label}<br>"
                + "<b>Average Price:</b> %{y:.2f}<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=False,
            ...
            .update_layout(
                ...
                legend_font=dict(size=13, color="white"),
                legend=dict(bgcolor="rgba(0,0,0,0)"),
                legend_title_text="Reviews",
                legend_title_font=dict(size=14, color="white"),
                barmode="stack",
            )
            .update_xaxes(title="Minimum Night", type="category"),
            use_container_width=True,
        )
        ...
        c.plotly_chart(
            ...
            .update_xaxes(title="Maximum Night", type="category"),
            use_container_width=True,
        )
        ...
        top_host = pd.DataFrame(
            df0.groupby(["host_id", "superhost"])
            .agg({"number_of_reviews": "count", "price": "sum"})
            .reset_index()
        ).nlargest(15, "price")
        ...
        a.plotly_chart(
            ...
            .update_layout(
                ...
                legend_font=dict(size=13, color="white"),
                legend=dict(bgcolor="rgba(0,0,0,0)"),
                legend_title_text="Super Host",
                legend_title_font=dict(size=14, color="white"),
                barmode="stack",
            )
            .update_xaxes(title="Host Id", type="category"),
            use_container_width=True,
        )

        b.markdown(
            "<div style='border-left: 3px solid #FF385C;font-family:PhonePeSans; height: 600px;'></div>",
            unsafe_allow_html=True,
        )
        ...
        top_host = pd.DataFrame(
            df0.groupby(["host_response_rate", "superhost"])
            .agg({"number_of_reviews": "count", "price": "sum"})
            .reset_index()
        ).nlargest(15, "price")
        ...
        c.plotly_chart(
            ...
            .update_xaxes(title="Host Response Rate", type="category"),
            use_container_width=True,
        )
    ...
    with tab2:
        ...
        avail_prpty = (
            df0.groupby("property_type")["annual_availability"]
            .mean()
        ...
        a.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Property Type:</b> %{label}<br>"
                + "<b>Annual Availability:</b> %{y:.0f} - Days<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=False,
                textfont=dict(size=12, color="#ffffff"),
        ...
        avail_room = (
            df0.groupby("room_type")["annual_availability"]
            .median()
            .reset_index(name="annual_availability")
            .sort_values(by="annual_availability", ascending=False)
        )
        ...
        avail_res_rate = (
            df0.groupby("host_response_rate")[["price", "number_of_reviews"]]
            .mean()
            .reset_index()
        )
        avail_res_rate.host_response_rate = avail_res_rate.host_response_rate.astype(
            "category"
        )
        st.dataframe(avail_res_rate)

        st.plotly_chart(
            create_plotly_charts(avail_res_rate, "Bar", "host_response_rate", "price")
        )
        ...
        st.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>host_response_rate:</b> %{label}<br>"
                + "<b>Annual Availability:</b> %{y:.0f} - Days<br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="red")),
                visible=True,
                showlegend=True,
    ...
    with tab3:
        ...
        a.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Contry:</b> %{label}<br>" + "<b>Count:</b> %{y} <br>",
        ...
        a.plotly_chart(
            ...
            .update_traces(
                hovertemplate="<b>Region:</b> %{label}<br>" + "<b>Count:</b> %{y} <br>",
                hoverlabel=dict(bgcolor="rgba(0,0,0,0)", font=dict(color="white")),
                visible=True,
                showlegend=False,
                textfont=dict(size=12, color="#ffffff"),
        ...
        avail_prpty = (
            df0.groupby(["region", "cancellation_policy"])["_id"]
            .count()
            .reset_index(name="Count")
            .sort_values(by="Count", ascending=False)
        )
        ...
        avail_room = (
            df0.groupby(["country", "cancellation_policy"])["_id"]
            .count()
            .reset_index(name="Count")
            .sort_values(by="Count", ascending=False)
        )
        ...
        avail_prpty = (
            df0.groupby("region")["number_of_reviews"]
            .sum()
        ...
        avail_room = (
            df0.groupby("country")["number_of_reviews"]
            .sum()
            .reset_index(name="Reviews_count")
            .sort_values(by="Reviews_count", ascending=False)
        )
    ...
    with tab4:
        ...
        listings_den = px.density_mapbox(
            df0,
            lat="latitude",
            lon="longitude",
            z="_id",
        ...
        listings_den.update_layout(
            mapbox_zoom=zoom_level,
            geo=dict(scope="asia", projection_type="equirectangular"),
            mapbox_center={"lat": cen_lat, "lon": cen_lon},
            margin={"r": 0, "t": 0, "l": 0, "b": 0},
            width=800,
            height=550,
        )
        listings_den.update_traces(
            hovertemplate="<b>%{hovertext}</b><br>Count: %{z} <br>Country: %{customdata[2]:,.2f} "
        )
        ...
        listings_price_den = px.density_mapbox(
            dff1,
            lat="latitude",
            lon="longitude",
            z="price",
        ...
        listings_price_den.update_layout(
            mapbox_zoom=zoom_level,
            geo=dict(scope="asia", projection_type="equirectangular"),
            mapbox_center={"lat": cen_lat, "lon": cen_lon},
            margin={"r": 0, "t": 0, "l": 0, "b": 0},
        ...
        listings_price_den.update_traces(
            hovertemplate="<b>%{hovertext}</b><br>Price: %{z:,.2f} <br>Region: %{customdata[2]} <br>Availability  - %{customdata[4]:,.0f}<br>Reviews Count - %{customdata[5]}"
        )
        ...
        aa = (
            px.scatter_geo(
                ...
                text="country",
                size_max=25,
                hover_data={"country": True, "price": True, "number_of_reviews": True},
                projection="equirectangular",
                color_continuous_scale="Magma",
            )
            .update_traces(
                textfont_color="#000000",
                hovertemplate="<br>Country: %{customdata[0]} <br>Price  - %{customdata[1]:,.0f}<br>Reviews Count - %{customdata[2]:,.0f}",
            )
            .update_layout(
                width=1000, height=800, geo=dict(center=dict(lat=cen_lat, lon=cen_lon))
            )
        )
        ...
        aa = (
            ...
            .update_traces(
                textfont_color="#000000",
                hovertemplate="<br>Country: %{customdata[2]} <br>Availability  - %{customdata[4]:,.0f}<br>Reviews Count - %{customdata[5]}",
            )
            .update_layout(
                width=1000, height=800, geo=dict(center=dict(lat=cen_lat, lon=cen_lon))
            )
        ...
        aa = (
            ...
            .update_traces(
                textfont_color="#000000",
                hovertemplate="<br>Rating: %{customdata[0]:,.2f}%  <br>Country: %{customdata[3]} <br>Availability  - %{customdata[4]:,.0f}<br>Reviews Count - %{customdata[5]:,.0f}",
            )
            .update_layout(
                width=1000, height=800, geo=dict(center=dict(lat=cen_lat, lon=cen_lon))
            )
    ...
    with open("EDA.html", "r", encoding="utf-8") as file:
        ...
        st.markdown(
            f'<iframe src="data:text/html;base64,{html_content}" width="1300" height="900"></iframe>',
            unsafe_allow_html=True,
        )
